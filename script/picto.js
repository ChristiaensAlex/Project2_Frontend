let mainPictoFile, pictoTags, tags, submitUpload;
...
const listenToSelectSubmit = function(selectedPicto) {
  ...
  selectSubmit.addEventListener('click', function() {
    ...
    submitUpload = document.querySelector('.c-submitrow-picto');
    submitUpload.classList.add('c-submit-uploadPicto');
...
const listenToSelect = function(json) {
  ...
  for (eachPicto of pictos) {
    eachPicto.addEventListener('click', function() {
      ...
      let submitUpload = document.querySelector('.c-submitrow-picto');
      submitUpload.classList.remove('c-submit-uploadPicto');
