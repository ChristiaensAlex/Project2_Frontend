...
URI = `https://localhost:44374/api/client/${clientId}/progressiveScheme`;
...
let ShowProgressiveSchemes = function (dataArraySchemeName, dataArrayPictoId, dataArrayChecked) {
    let html = "";
    for (let i = 0; i < dataArraySchemeName.length; i++) {
        console.log(dataArrayChecked);
        html += `<div class="c-progressiveScheme ${dataArrayChecked[i]}">
...
let processProgressiveSchemes = function (queryResponse) {
    ...
    for (var addChecked of queryResponse) {
        ...
        if (F == true) {
            ischecked = "c-progressiveScheme__done";
        }
        else {
            ischecked = "";
    ...
    console.log(dataArraySchemeName, dataArrayPictoId, dataArrayChecked)
    ShowProgressiveSchemes(dataArraySchemeName, dataArrayPictoId, dataArrayChecked);
};
...
// Alle stappenplannen van vandaag
// [
//     {
//         "clientProgressiveSchemeId": "3fa85f64-5717-4562-b3fc-2c963f66afa6",
//         "progressiveSchemeId": "3fa85f64-5717-4562-b3fc-2c963f66afa6",
//         "pictoId": "3fa85f64-5717-4562-b3fc-2c963f66afa6",
//         "schemeName": "string",
//         "currentStep": 0,
//         "schedule": "2020-01-24T11:21:32.644Z",
//         "done": true
//     }
// ]
